    ...
    internal static class Comparisons
    {
        ...
        private static readonly Dictionary<Type, Func<object, object, bool>> s_equalityMethods =
            new Dictionary<Type, Func<object, object, bool>>
            {
                ...
                [typeof(Distance)] = CastFromObject<Distance>(MatchableCompare),
                [typeof(ManhattanDistance)] = CastFromObject<Distance>(MatchableCompare),
                [typeof(ChebyshevDistance)] = CastFromObject<Distance>(MatchableCompare),
                [typeof(EuclideanDistance)] = CastFromObject<Distance>(MatchableCompare),
